        ...
        <div className="lg:mx-4 sm:mx-0 space-y-4">
          ...
          <div className="p-4 rounded-[20px] border border-gray-250">
            <div className="flex justify-between items-center pt-2 pb-6">
              ...
              <button onClick={() => setIsFilterModalOpen(true)} className="flex items-center cursor-pointer space-x-6 font-medium text-sm text-gray-350 hover:text-gray-800 border border-gray-250 rounded-[10px] px-4 py-2">
                <span>Year</span>
