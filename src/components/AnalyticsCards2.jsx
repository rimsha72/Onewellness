        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 font-manrope mt-6">
            ...
            <div className="bg-gradient-to-r from-white to-green-150/20 rounded-[20px] p-6 flex flex-col border border-gray-250 transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex items-center space-x-3">
                    ...
                    <h2 className="text-base font-medium text-gray-350">Tools Usage</h2>
                </div>
            ...
            <div className="bg-gradient-to-r from-white to-green-150/20 rounded-[20px] p-6 flex flex-col border border-gray-250 transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex items-center space-x-3">
                    ...
                    <h2 className="text-base font-medium text-gray-350">Premium Users</h2>
                </div>
                <div className="flex items-baseline space-x-3">
            ...
            <div className="bg-gradient-to-r from-white to-green-150/20 rounded-[20px] p-6 flex flex-col border border-gray-250 transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex items-center space-x-3">
                    ...
                    <h2 className="text-base font-medium text-gray-350">Businesses</h2>
                </div>
                <div className="flex items-baseline space-x-3">
