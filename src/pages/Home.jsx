        ...
        <div className="lg:mx-4 sm:mx-0 space-y-4">
          <div className="flex justify-between lg:flex-row flex-col lg:items-center items-start gap-2">
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-3 ">
              <button className="border cursor-pointer border-green-150 rounded-xl text-sm text-green-150 hover:scale-101 font-medium py-2.5 px-4 transition duration-200 flex items-center gap-3">
              ...
              <button onClick={openRoleModal} className="cursor-pointer border border-green-150 bg-green-150/20 hover:scale-101 rounded-xl text-sm text-green-150 font-medium py-2.5 px-4 transition duration-200">
                Set Roles
              </button>
              <button
                onClick={openModal}
                className="border cursor-pointer border-green-150 bg-green-150 rounded-xl text-sm text-white hover:scale-101 font-medium py-2.5 px-4 transition duration-200"
              >
                Post in Community
              </button>
            </div>
          ...
          <div className="w-full">
            ...
            <div className="flex border border-green-150 rounded-[16px] p-1 bg-white max-w-[204px]">
              <button
                className={`flex-1 py-3 px-4 text-sm font-semibold cursor-pointer rounded-[12px] transition-colors duration-200 ${activeTab === 'overview'
              ...
              <button
                className={`flex-1 py-3 px-4 text-sm font-semibold cursor-pointer rounded-[12px] transition-colors duration-200 ${activeTab === 'my-posts'
                   ? 'bg-green-150 text-white'
                    : 'bg-transparent text-black-350 hover:bg-gray-100'
                  }`}
