        ...
        <div className="lg:mx-4 sm:mx-0 space-y-4">
          ...
          <div className="space-y-4">
            {roles.map((role) => (
              <div
                key={role.id}
                className="flex items-center justify-between px-4 py-5 border border-gray-250 rounded-[20px]"
              >
                ...
                <div className="flex gap-3 items-center">
                  ...
                  <button className="text-white bg-green-150 transition duration-200 flex items-center px-4 py-3 rounded-xl font-medium"   onClick={openModal}>
