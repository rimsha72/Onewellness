...
const PremiumUsersSubscription = () => {
 ...
 const [isFilterModalOpen, setIsFilterModalOpen] = useState(false);
    const users = [
        ...
        { name: 'Michael Chang', date: '28 September 2024', email: 'Bob789d@email.com', enddate: '9 November 2024', avatar: profile3 },
        { name: 'Emily Rodriguez', date: '29 September 2024', email: 'Eve012e@email.com', enddate: '9 November 2024', avatar: profile4 },
        { name: 'David Patel', date: '30 September 2024', email: 'Grace345f@email.com', enddate: '9 November 2024', avatar: profile5 },
    ];
                    ...
                    <table className="w-full text-left text-base text-gray-350">
                        <thead className="border-b border-t border-gray-250 font-medium">
                            <tr>
                                ...
                                <th className="py-4 px-4 font-medium">Subscription start date</th>
                                <th className="py-4 px-4 font-medium">Subscription end date</th>
                        ...
                        <tbody>
                            {users.map((user, index) => (
                                <tr key={index} className="border-b border-gray-250 hover:bg-gray-50 text-black-150 font-medium">
                                    ...
                                    <td className="py-4 px-4">{user.enddate}</td>
                                    <td className="py-4 px-4">
                                        <button
                                            className="bg-green-150 cursor-pointer font-medium text-white text-sm py-2 px-3 rounded-xl transition duration-200"
...
export default PremiumUsersSubscription;