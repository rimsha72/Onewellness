      ...
      <div className="max-w-screen-3xl mx-auto font-manrope">
        <div className="lg:mx-4 sm:mx-0 space-y-4">
          <div className="flex justify-between lg:flex-row flex-col lg:items-center items-start gap-2">
            <button onClick={() => navigate('/businesses')} className="button cursor-pointer font-bold text-2xl flex items-center gap-4"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex lg:flex-row flex-col gap-4 w-full mt-6">
            <div className="lg:w-1/5 w-full border border-gray-250 p-4 rounded-[20px]">
              ...
              <h1 className="text-black-150 text-[20px] font-semibold mt-3 text-center">John Bushmill</h1>
              <p className="text-gray-350 text-sm text-center mt-1 pb-4 border-b border-gray-250">Laura stuff is lorem ipsum dolor sit amet bla bla lorem ipsum dolor sit amet.</p>
              <div className="mt-4 space-y-4 text-sm font-medium">
                ...
                <div>
                  <button className="w-full cursor-pointer border border-green-150 rounded-2xl text-green-150 font-medium text-sm py-2.5">Send Message</button>
                </div>
              </div>
            </div>
